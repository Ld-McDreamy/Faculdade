...
public class Salgadinho implements Item, Produto{

	private String nome, departamento, info, data;
	private double preco;
	
	// Construtor
	public Salgadinho(String nome, double preco, String departamento, String info, String data) {
		this.nome = nome;
		this.preco = preco;
	...
	public double calcularPrecoFinal() {
		preco *= 1.3; // Dica Aleatória: 0.1 ou .1 é igual
		return preco;
	}
